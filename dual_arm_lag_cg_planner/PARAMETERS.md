# <p align="center">Parameter Reference — dual_arm_lag_cg_planner</p>

<p align="justify">
All tunable parameters of this planner reside in <code>config/dual_arm_lag_cg_planning.yaml</code> (this table = the yaml comments + supplementary notes). Modification workflow: edit the yaml → copy it to <code>hiwin_dual_arm/config/</code> → restart move_group for the changes to take effect ( <b> no recompilation needed </b> ).
</p>
...
## Pure Lagrangian Parameters (corresponding to Dual_Arm_Lagrangian_Con_v2)
