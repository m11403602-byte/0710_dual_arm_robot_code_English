...
3. Once both the start and goal are set, press <b> Plan </b>; upon successful planning, the 3D view plays the trajectory animation, and the elapsed time is printed in the log at the lower-left corner.
