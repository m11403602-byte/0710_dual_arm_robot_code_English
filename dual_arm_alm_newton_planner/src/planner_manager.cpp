...
// =====================================================================
#include "dual_arm_alm_newton_planner/planner_manager.hpp"
...
// PlannerManager
// =====================================================================
bool DualArmAlmNewtonPlannerManager::initialize(const moveit::core::RobotModelConstPtr& model,
...
void DualArmAlmNewtonPlannerManager::load_parameters() const
{
...
void DualArmAlmNewtonPlannerManager::getPlanningAlgorithms(std::vector<std::string>& algs) const
{
  algs.clear();
  algs.push_back("DualArmAvoidanceNewton");
}

void DualArmAlmNewtonPlannerManager::setPlannerConfigurations(
...
planning_interface::PlanningContextPtr DualArmAlmNewtonPlannerManager::getPlanningContext(
...
bool DualArmAlmNewtonPlannerManager::canServiceRequest(
...
PLUGINLIB_EXPORT_CLASS(
    dual_arm_alm_newton_planner::DualArmAlmNewtonPlannerManager,
