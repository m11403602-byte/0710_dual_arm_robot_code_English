...
// =====================================================================
class DualArmAlmNewtonPlannerManager : public planning_interface::PlannerManager
{
public:
  DualArmAlmNewtonPlannerManager() = default;
  ~DualArmAlmNewtonPlannerManager() override = default;
  ...
  std::string getDescription() const override { return "Dual-Arm Avoidance Planner (Newton)"; }
