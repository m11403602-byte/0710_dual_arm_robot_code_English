...
#define DUAL_ARM_AVOIDANCE_PLANNER_CG_SOLVER_HPP
...
struct SolverLog {
  ...
  std::vector<double> alpha_history;     // CG line-search step length
...
#endif  // DUAL_ARM_AVOIDANCE_PLANNER_CG_SOLVER_HPP
