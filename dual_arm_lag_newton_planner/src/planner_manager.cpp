...
// =====================================================================
#include "dual_arm_lag_newton_planner/planner_manager.hpp"
...
bool DualArmPlanningContext::solve(planning_interface::MotionPlanResponse& res)
{
  ...
  optimizer.set_lag_params(lag_wd_, lag_lam0_, lag_s0_,
                           lag_tol_phys_, lag_tol_stable_, lag_tol_stat_, lag_max_iter_);   // [NEW] yaml → pure Lagrangian injection
  optimizer.set_solver_verbose(solver_verbose_);   // [NEW] yaml → inner verbose passthrough
...
// PlannerManager
// =====================================================================
bool DualArmLagNewtonPlannerManager::initialize(const moveit::core::RobotModelConstPtr& model,
...
void DualArmLagNewtonPlannerManager::load_parameters() const
{
...
void DualArmLagNewtonPlannerManager::getPlanningAlgorithms(std::vector<std::string>& algs) const
{
  algs.clear();
  algs.push_back("DualArmAvoidanceLagNewton");
}

void DualArmLagNewtonPlannerManager::setPlannerConfigurations(
...
planning_interface::PlanningContextPtr DualArmLagNewtonPlannerManager::getPlanningContext(
    ...
    moveit_msgs::msg::MoveItErrorCodes& error_code) const
{
  ...
  context->lag_tol_stat_ = lag_tol_stat_; context->lag_max_iter_ = lag_max_iter_;

  error_code.val = moveit_msgs::msg::MoveItErrorCodes::SUCCESS;
  return context;
}

bool DualArmLagNewtonPlannerManager::canServiceRequest(
...
PLUGINLIB_EXPORT_CLASS(
    dual_arm_lag_newton_planner::DualArmLagNewtonPlannerManager,
