...
├── CMakeLists.txt
├── package.xml
├── dual_arm_lag_newton_planner.xml
├── README.md
├── PARAMETERS.md
├── config/
│   └── dual_arm_lag_newton_planner.yaml
├── include/dual_arm_lag_newton_planner/
│   ├── newton_solver.hpp
...
```bash
cd ~/ros2_ws
colcon build --packages-select dual_arm_lag_newton_planner
